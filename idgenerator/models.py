...
class DocUkraineInternational(models.Model):
    ...
    photo_doc = models.ImageField('Фото в паспорт', upload_to='media/cfg/input/')
    ...
    remove_bg = models.BooleanField(verbose_name='Удаление фона с фото [ТЕСТОВО]', default=False)
...
class StateCardUsa(models.Model):
    passport_card_number = models.CharField(verbose_name="Passpord Card Num", default="C000091", max_length=9)
    nationality = models.CharField(verbose_name="Nationalyti", max_length=15, default="USA")
    surname = models.CharField(verbose_name="Surname", max_length=24, default="Johnson")
    given_names = models.CharField(verbose_name="Given Names", max_length=24, default="John")
    sex = models.CharField(verbose_name="Sex", max_length=3, default="M")
    date_of_birdth = models.CharField(verbose_name="Date of Birth", max_length=20, default="01 JAN 1986")
    place_of_birth = models.CharField(verbose_name="Place of Birth", max_length=50, default="NEW YORK USA")
    issues_on = models.CharField(verbose_name="Issued On", max_length=15, default="16 MAY 08")
    expiries_on = models.CharField(verbose_name="Expires On", max_length=15, default="16 MAY 18")
    documment_id = models.CharField(verbose_name="Document ID", max_length=7, default="A123456")
    photo_document = models.ImageField(verbose_name="Photo iD", upload_to="media/cfg/usa/photo_id/", null=True)
    remove_bg = models.BooleanField(verbose_name='Remove background [BETA]', default=False)
    get_exif_info = models.ImageField(verbose_name='Загрузить фото для копирования EXIF', upload_to='media/cfg/exif_tool/', null=True)
    background_image = models.ImageField(verbose_name='Загрузить фон', upload_to='media/cfg/background_image/', null=True)
