...
def get_data_from_form(date_form):
    ...
    save_after_main_data_p = write_main_data(mrz, 'media/cfg/tmp/after_m_data.png', 'P', country, passport_number, surname, given_name, genre, birth_date,
    ...
    path_with_holohrama = holohrama_paster(temp_face_photo_path, path_gg)
