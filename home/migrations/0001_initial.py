# Generated by Django 3.2.9 on 2021-11-12 22:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_exp_date', models.CharField(default='991220', max_length=6, verbose_name='Expiry date')),
                ('optional_data', models.CharField(blank=True, default='B3XLC000FD142955', max_length=16, verbose_name='Optional data')),
                ('photo_document', models.ImageField(blank=True, upload_to='media/cfg/usa/usavisa/', verbose_name='Photo iD')),
                ('remove_bg', models.BooleanField(default=False, verbose_name='Remove background [BETA]')),
                ('get_exif_info', models.ImageField(blank=True, upload_to='media/cfg/usa/exif_tool/', verbose_name='Load image  EXIF')),
                ('background_image', models.ImageField(blank=True, upload_to='media/cfg/usa/background_image/', verbose_name='Загрузить фон')),
            ],
            options={
